...
public class Magpie2
{
	...
	public String getResponse(String statement)
	{
      ...
      String temp = statement.trim();
      ...
      else if (statement.indexOf("Ms.") >= 0 || statement.indexOf("Misses") >= 0 || statement.indexOf("Mrs.") >= 0)
		{
		...
		{
			response = "Im glad you're happy.";
		}
      else if (statement.indexOf("Boring") >= 0)
		{
			response = "Sorry im not interesting to talk to.";
		}
		else
		{
